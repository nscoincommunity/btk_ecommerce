...
class ControllerCatalogProduct extends Controller {
	...
	public function index() {
		...
		$this->load->model('klu/klu');

		// $this->model_klu_klu->alterTables();
		$this->model_catalog_product->alterTables();
		$this->model_klu_klu->alterTables();
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$supplier = $this->model_supplier_supplier->getSupplierByProduct($result['product_id']);
		...
		$data['sort_name'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.product_name' . $url, true);
		$data['sort_supplier'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=s.name' . $url, true);
